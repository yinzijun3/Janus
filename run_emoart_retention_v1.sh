...
RETENTION_MANIFEST="/root/autodl-tmp/emoart_gen_runs/retention_prompts_v1.jsonl"
TRAIN_OUT="/root/autodl-tmp/emoart_gen_runs/out_gen_expA_retention_v1_bs8"
COMPARE8_OUT="/root/autodl-tmp/emoart_gen_runs/out_gen_compare_expA_retention_v1_bs8_8"
COMPARE32_OUT="/root/autodl-tmp/emoart_gen_runs/out_gen_compare_expA_retention_v1_bs8_32"
...
case "${MODE}" in
  train)
    python "${REPO_DIR}/train_emoart_gen_lora.py" \
      ...
      --retention-loss-weight 0.2 \
      --retention-token-prefix 64 \
